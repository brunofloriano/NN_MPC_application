function individual_state = group_dynamics(individual_state,K,Adjacency,delta_t)
    ...
    for agent_counter_i = 1:N
        ...
        individual_control_input = K(agent_counter_i); %-K*weighted_sum;
    ...
    individual_state{1} = dynamics(individual_state{1},individual_control_input*0,delta_t); % Virtual agent dynamics
    individual_state{2}(1) = 0;
end