...
dynamic_function0 = 'state0(:,i) = A*state0(:,i-1) + [sin( [1 0]*state0(:,i-1)  );1 - cos( [0 1]*state0(:,i-1) )];';
vdynamic_function0 = 'vstate0(:,vtime) = A*vstate0(:,vtime-1) + [sin( [1 0]*vstate0(:,vtime-1)  );1 - cos( [0 1]*vstate0(:,vtime-1) )];';
